...
import type { GetUserInputData, GetUserInputError, GetUserInputResponse, GetUserInputUsernameData, GetUserInputUsernameError, GetUserInputUsernameResponse, GetUserByIdData, GetUserByIdError, GetUserByIdResponse, GetUserDataByIdData, GetUserDataByIdError, GetUserDataByIdResponse, PostUserData, PostUserError, PostUserResponse, PostUserTodoListData, PostUserTodoListError, PostUserTodoListResponse, DeleteUserTodoListByIdData, DeleteUserTodoListByIdError, DeleteUserTodoListByIdResponse, PostUserTodoListTaskData, PostUserTodoListTaskError, PostUserTodoListTaskResponse, DeleteUserTodoListTaskByIdData, DeleteUserTodoListTaskByIdError, DeleteUserTodoListTaskByIdResponse, PostUserTodoListTaskSubtaskData, PostUserTodoListTaskSubtaskError, PostUserTodoListTaskSubtaskResponse } from './types.gen';
...
export const getUserInputUsername = <ThrowOnError extends boolean = false>(options: Options<GetUserInputUsernameData, ThrowOnError>) => { return (options?.client ?? client).get<GetUserInputUsernameResponse, GetUserInputUsernameError, ThrowOnError>({
    ...options,
    url: '/user/input/username'
}); };
