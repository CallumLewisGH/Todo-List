...
import type { GetByIdData, GetByIdError, GetByIdResponse, GetUserByIdData, GetUserByIdError, GetUserByIdResponse, PutUserByIdData, PutUserByIdError, PutUserByIdResponse, DeleteUserByIdData, DeleteUserByIdError, DeleteUserByIdResponse, PostUserData, PostUserError, PostUserResponse, GetUserTodoListData, GetUserTodoListError, GetUserTodoListResponse, PostUserTodoListData, PostUserTodoListError, PostUserTodoListResponse, PutUserTodoListByIdData, PutUserTodoListByIdError, PutUserTodoListByIdResponse, DeleteUserTodoListByIdData, DeleteUserTodoListByIdError, DeleteUserTodoListByIdResponse, GetUserTodoListTaskData, GetUserTodoListTaskError, GetUserTodoListTaskResponse, PostUserTodoListTaskData, PostUserTodoListTaskError, PostUserTodoListTaskResponse, PutUserTodoListTaskByIdData, PutUserTodoListTaskByIdError, PutUserTodoListTaskByIdResponse, DeleteUserTodoListTaskByIdData, DeleteUserTodoListTaskByIdError, DeleteUserTodoListTaskByIdResponse, GetUserTodoListTaskSubtaskData, GetUserTodoListTaskSubtaskError, GetUserTodoListTaskSubtaskResponse, PostUserTodoListTaskSubtaskData, PostUserTodoListTaskSubtaskError, PostUserTodoListTaskSubtaskResponse, PutUserTodoListTaskSubtaskByIdData, PutUserTodoListTaskSubtaskByIdError, PutUserTodoListTaskSubtaskByIdResponse, DeleteUserTodoListTaskSubtaskByIdData, DeleteUserTodoListTaskSubtaskByIdError, DeleteUserTodoListTaskSubtaskByIdResponse } from './types.gen';
...
export const getUserTodoList = <ThrowOnError extends boolean = false>(options: Options<GetUserTodoListData, ThrowOnError>) => { return (options?.client ?? client).get<GetUserTodoListResponse, GetUserTodoListError, ThrowOnError>({
    ...options,
    url: '/user/todoList'
}); };
...
export const getUserTodoListTask = <ThrowOnError extends boolean = false>(options: Options<GetUserTodoListTaskData, ThrowOnError>) => { return (options?.client ?? client).get<GetUserTodoListTaskResponse, GetUserTodoListTaskError, ThrowOnError>({
    ...options,
...
export const getUserTodoListTaskSubtask = <ThrowOnError extends boolean = false>(options: Options<GetUserTodoListTaskSubtaskData, ThrowOnError>) => { return (options?.client ?? client).get<GetUserTodoListTaskSubtaskResponse, GetUserTodoListTaskSubtaskError, ThrowOnError>({
    ...options,
