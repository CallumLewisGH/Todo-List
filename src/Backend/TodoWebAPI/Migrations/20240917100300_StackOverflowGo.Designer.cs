...
namespace TodoWebAPI.Migrations
{
    ...
    [Migration("20240917100300_StackOverflowGo")]
    partial class StackOverflowGo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TodoWebAPI.DTOs.SubTaskDTO", b =>
                {
                    b.HasOne("TodoWebAPI.DTOs.TaskDTO", null)
                        .WithMany("SubTasks")
            ...
            modelBuilder.Entity("TodoWebAPI.DTOs.TaskDTO", b =>
                {
                    b.HasOne("TodoWebAPI.DTOs.TodoListDTO", null)
                        .WithMany("Tasks")
            ...
            modelBuilder.Entity("TodoWebAPI.DTOs.TodoListDTO", b =>
                {
                    b.HasOne("TodoWebAPI.DTOs.UserDTO", null)
                        .WithMany("TodoLists")
