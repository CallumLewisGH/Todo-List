<template>
    ...
    <template v-for="list in inputList">
        <div @click="handleLoadedList(list)" class="list_link" id="list_link">
            ...
            <img src="../assets/Cross.png" width="17.5vh" style=" float: right; margin-top: 2%; margin-right: 3%;" @click="handleDeleteList(list.listId!)">
    ...
    <div class="list_link" id="list_link">
        ...
        <input type="text" placeholder="Enter List Name..." v-model="input_text" @keyup.enter = "input_text = ''" @keydown.enter="handleCreateList(input_text, 0 )"
...
import { ref, } from 'vue';
import { type TodoListDTO, type TodoListObjectDTO, type UserDTO} from '@/client'
